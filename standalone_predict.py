...
# making prediction throught saved model
...
def model_predict(file_path, model):
    from tensorflow.keras.preprocessing import image
    # loading the images, target size should be equal to input size of image while training , we used earlier (30,30) on training 
